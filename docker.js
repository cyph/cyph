...
const shellScripts			= {
	...
	aptUpdate: {
		command: `
			...
			emsdk install binaryen-master-64bit clang-e1.37.21-64bit emscripten-incoming-64bit
			emsdk activate binaryen-master-64bit clang-e1.37.21-64bit emscripten-incoming-64bit
