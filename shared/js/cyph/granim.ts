...
import {env} from '../env';
import {waitForIterable} from './wait';
 ...
 */
export const initGranim	= async (opts: Record<string, any>) : Promise<undefined|{
	...
	const elem		= (await waitForIterable(() => document.querySelectorAll(selector)))[0];
