...
export class StringsService extends BaseProvider {
	...
	/** @see StringsService */
	public readonly addContactTooltipExternal: string = `Add someone using their email address`;

	/** @see StringsService */
	public readonly addContactTooltipInternal: string = `Add someone using their ${this.internalProductShort} username`;

	/** @see StringsService */
	public readonly addContactTooltipInvite: string = `Invite a friend to make their own ${this.internalProductShort} account`;
	...
	/** @see StringsService */
	public readonly bannerTextAlt: string = `Help Defend Internet Privacy: Donate to ${this.internalCompany}`;
	...
	/** @see StringsService */
	public readonly changeMasterKeyFailure: string = `Changing the master key failed. Please try again later.`;
	...
	/** @see StringsService */
	public readonly changePinFailure: string = `Changing the lock screen password failed. Please try again later.`;
	...
	/** @see StringsService */
	public readonly checkoutErrorEnd: string = `Please check your payment credentials and try again.`;

	/** @see StringsService */
	public readonly checkoutErrorStart: string = `Processing payment failed`;
	...
	/** @see StringsService */
	public readonly cypherToast1: string = `Prepare to witness the amazing nuts and bolts of ${this.internalProductShort}.`;

	/** @see StringsService */
	public readonly cypherToast2: string = `This cyphertext is what outsiders spying on your traffic will see (nothing of value).`;
	...
	/** @see StringsService */
	public readonly disconnectConfirm: string = `Are you sure that you wish to disconnect?`;

	/** @see StringsService */
	public readonly disconnectNotification: string = `This ${this.internalSession} has been disconnected.`;

	/** @see StringsService */
	public readonly disconnectTitle: string = `Disconnect`;

	/** @see StringsService */
	public readonly disconnectWarning: string = `After closing this ${this.internalSession}, your messages will no longer be retrievable.`;
	...
	/** @see StringsService */
	public readonly fileTooLarge: string = `The file that you are trying to send exceeds the 250 MB attachment limit.`;

	/** @see StringsService */
	public readonly fileTransferInitFriend: string = `Your ${this.internalFriend} is sending the file:`;

	/** @see StringsService */
	public readonly fileTransferInitMe: string = `You are sending the file:`;
	...
	/** @see StringsService */
	public readonly friendIsTyping: string = `${this.capitalize(
		this.internalFriend
	)} is typing...`;
	...
	/** @see StringsService */
	public readonly getMessageValueFailure: string = `\`[Failed to fetch the contents of this message]\``;
	...
	/** @see StringsService */
	public readonly gdprContactFormShort: string = `Data Collection Consent`;
	...
	/** @see StringsService */
	public readonly incomingFileSaveError: string = `Failed to save the following file:`;

	/** @see StringsService */
	public readonly incomingFileSaveMediaError: string = `Failed to download.`;

	/** @see StringsService */
	public readonly incomingFileUploadError: string = `Failed to upload the following file:`;
	...
	/** @see StringsService */
	public readonly incomingPatientInfoTitle: string = `Saving Incoming Patient Info`;

	/** @see StringsService */
	public readonly introductoryMessage: string = `You may now speak.`;

	/** @see StringsService */
	public readonly invalidCredentials: string = `Invalid username or master key.`;

	/** @see StringsService */
	public readonly invalidInviteCode: string = `Invalid invite code.`;

	/** @see StringsService */
	public readonly invalidPassword: string = `Invalid password.`;

	/** @see StringsService */
	public readonly invalidPIN: string = `Invalid lock screen password.`;

	/** @see StringsService */
	public readonly inviteContactTitle: string = `Invite Contact`;

	/** @see StringsService */
	public readonly linkCopied: string = `${this.capitalize(
		this.internalSession
	)} link copied.`;

	/** @see StringsService */
	public readonly linkCopyFail: string = `Automated clipboard copy unsupported in this browser.`;

	/** @see StringsService */
	public readonly linkEmailSubject: string = `${this.internalProductShort} Chat Invite`;

	/** @see StringsService */
	public readonly linkEmailSubjectTelehealth: string = `Your Telehealth Appointment`;
	...
	/** @see StringsService */
	public readonly linkGet: string = `Get new ${this.internalProduct} link`;

	/** @see StringsService */
	public readonly linkTooltip: string = `${this.capitalize(
		this.internalSession
	)} Link`;
	...
	/** @see StringsService */
	public readonly messageConfirmed: string = `Message delivery confirmed`;
	...
	/** @see StringsService */
	public readonly messageUnconfirmed: string = `Message delivery unconfirmed`;
	...
	/** @see StringsService */
	public readonly newWalletGenerateText: string = `This will generate a brand new wallet. Proceed?`;
	...
	/** @see StringsService */
	public readonly newWalletImportAddressText: string = `Add a read-only wallet to track the following public address:`;
	...
	/** @see StringsService */
	public readonly newWalletImportKeyText: string = `Import existing wallet private key in WIF format:`;
	...
	/** @see StringsService */
	public readonly newWalletNameText: string = `Name of this wallet:`;
	...
	/** @see StringsService */
	public readonly noIncomingAppointments: string = `You have no incoming appointment requests`;
	...
	/** @see StringsService */
	public readonly outgoingFileError: string = `Failed to send the following file:`;

	/** @see StringsService */
	public readonly outgoingFileRejected: string = `Your "${this.internalFriend}" has rejected the following file transfer:`;

	/** @see StringsService */
	public readonly outgoingFileSaved: string = `File transfer complete! Your ${this.internalFriend} has saved the following file:`;

	/** @see StringsService */
	public readonly p2pAccountChatNotice: string = `This is an ephemeral chat session available during your call. No logs will be saved.`;
	...
	/** @see StringsService */
	public readonly p2pDeny: string = `Your "${this.internalFriend}" has rejected your call.`;
	...
	/** @see StringsService */
	public readonly p2pDisabledLocalIOS: string = `Voice/video calling is currently unsupported on iOS.`;

	/** @see StringsService */
	public readonly p2pDisconnect: string = `Call has been disconnected.`;

	/** @see StringsService */
	public readonly p2pInit: string = `You are about to initiate an encrypted`;

	/** @see StringsService */
	public readonly p2pRequest: string = `Your ${this.internalFriend} has requested an encrypted`;

	/** @see StringsService */
	public readonly p2pRequestConfirmation: string = `Your request has been sent.`;
	...
	/** @see StringsService */
	public readonly patents: string = `US Patents 9,906,369 et al.`;
	...
	/** @see StringsService */
	public readonly selfDestructActivated: string = `${this.capitalize(
		this.internalSession
	)} set to self-destruct.`;

	/** @see StringsService */
	public readonly selfDestructDeactivated: string = `Self-destruct deactivated.`;
	...
	/** @see StringsService */
	public readonly sessionComplete: string = `${this.internalSession[0].toUpperCase()}${this.internalSession.slice(
		1
	)} complete.`;
	...
	/** @see StringsService */
	public readonly shareEhrDataFailure: string = `Sharing medical data failed.`;

	/** @see StringsService */
	public readonly shareEhrDataSuccess: string = `Medical data has been shared.`;
	...
	/** @see StringsService */
	public readonly signupFailed: string = `Signup failed. Please try again later.`;
	...
	/** @see StringsService */
	public readonly waitingRoomCheckedInDoctor: string = `Waiting for your patient to connect.`;

	/** @see StringsService */
	public readonly waitingRoomCheckedInGeneric: string = `Waiting for the other party to join.`;

	/** @see StringsService */
	public readonly waitingRoomCheckedInPatient: string = `You're all checked in! Waiting for your doctor to connect. `;

	/** @see StringsService */
	public readonly waitingRoomNotReadyForms: string = `Please ensure you've submitted all required patient forms.`;
