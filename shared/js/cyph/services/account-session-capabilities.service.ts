...
implements ISessionCapabilitiesService {
	...
	public initEphemeral () : void {
		const sessionCapabilitiesService	= new SessionCapabilitiesService(this.sessionService);
		...
		this.capabilities.walkieTalkieMode.then(walkieTalkieMode => {
			sessionCapabilitiesService.resolveWalkieTalkieMode(walkieTalkieMode);
		});
