...
export * from './maybe-timed-array-proto';
...
export const BooleanMapProto: IProto<{
	[k: string]: boolean;
}> = new GenericMapProto(Internal.BooleanMap);

/** Boolean encoder/decoder. */
export const BooleanProto: IProto<boolean> = new GenericProto(
...
export const NumberProto: IProto<number> = new GenericProto(
	Internal.NumberValue
);

/** String array encoder/decoder. */
export const StringArrayProto: IProto<string[]> = new GenericArrayProto(
	Internal.StringArray
);

/** String map encoder/decoder. */
export const StringMapProto: IProto<{
	[k: string]: string;
}> = new GenericMapProto(Internal.StringMap);

/** String encoder/decoder. */
export const StringProto: IProto<string> = new GenericProto(
	Internal.StringValue
);

/** Uint32 array encoder/decoder. */
export const Uint32ArrayProto: IProto<number[]> = new GenericArrayProto(
	Internal.Uint32Array
);

/** Uint32 encoder/decoder. */
export const Uint32Proto: IProto<number> = new GenericProto(
	Internal.Uint32Value
);
