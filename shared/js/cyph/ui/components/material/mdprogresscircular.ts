...
/**
 * ng2 wrapper for Material1 md-progress-circular.
 */
@Directive({
...
export class MdProgressCircular
	...
	/** Component title. */
	public static readonly title: string	= 'ng2MdProgressCircular';
	...
	constructor (
		...
		super(MdProgressCircular.title, elementRef, injector);
	}
}
