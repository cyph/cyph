...
@Directive({
	...
	selector: 'md-card-title-text'
})
export class MdCardTitleText
	extends UpgradeComponent implements DoCheck, OnChanges, OnInit, OnDestroy {
	/** Component title. */
	public static readonly title: string	= 'ng2MdCardTitleText';
	...
	constructor (
		...
		super(MdCardTitleText.title, elementRef, injector);
	}
}
