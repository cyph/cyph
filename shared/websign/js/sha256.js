var Sha256	= (function () {
	function polyfill (data, callback) {
		...
		Sha256	= function (data, callback) {
			callback(nacl.util.encodeHex(sha256(nacl.util.decodeUTF8(data))));
		};
	...
	return function (data, callback) {
		try {
			crypto.subtle.digest('SHA-256', nacl.util.decodeUTF8(data)).
				then(function (hash) {
					callback(nacl.util.encodeHex(new Uint8Array(hash)));
				}).
				catch(function () {
					polyfill(data, callback);
				})
			;
		}
		catch (_) {
