...
#CIRCLECI:RUN bash -c 'cd /node_modules/tslint ; npm install "typescript@$(node -e '"'"'console.log(JSON.parse(fs.readFileSync("package.json").toString()).devDependencies.typescript)'"'"')"'
