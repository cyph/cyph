...
RUN bash -c ' \
	...
	while true ; do sleep 5 ; echo y ; done | $ANDROID_HOME/tools/bin/sdkmanager \
		"tools" \
		"platform-tools" \
...
#CIRCLECI:RUN git clone --depth 1 -b 0.5.0 https://github.com/jedisct1/libsodium.js ~/getlibs/shared/lib/js/libsodium
