...
RUN npm -g install html-minifier clean-css uglifyjs typescript typings typedoc babel-cli babel-preset-es2015 jspm browserstack browserify libsodium-wrappers glob read mkdirp
