...
echo '' | base64 --decode | patch @angular-devkit/build-angular/src/tools/babel/presets/application.js
...
# Temporary workaround pending https://github.com/protobufjs/protobuf.js/pull/1824
echo 'NzA1YzcwNQo8ICAgICAgICAgZW5tLnBhcmVudCBpbnN0YW5jZW9mIHByb3RvYnVmLlJvb3QgPyAiQGV4cG9ydHMgIiArIGVzY2FwZU5hbWUoZW5tLm5hbWUpIDogIkBuYW1lICIgKyBleHBvcnROYW1lKGVubSksCi0tLQo+ICAgICAgICAgIkBuYW1lICIgKyBleHBvcnROYW1lKGVubSksCg==' | base64 --decode | patch protobufjs-cli/targets/static.js
