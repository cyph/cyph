...
# Temporary workaround pending https://github.com/angular/angular-cli/pull/20810
echo 'Mzc2YTM3Nwo+ICAgICAgICAgICAgICAgICAgICAgcmVzb2x2ZToge2Z1bGx5U3BlY2lmaWVkOiBmYWxzZX0sCg==' | base64 --decode | patch @angular-devkit/build-angular/src/webpack/configs/common.js
